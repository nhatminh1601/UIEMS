	...
	<nav class="nav-section">
		<div class="container">
			...
			<ul class="main-menu">
				...
				<li><a href="course.blade.php">COURSES</a></li>
				...
				<div class="col-lg-8 post-list">
					<div class="post-item">
						...
						<div class="post-content">
							<h3><a href="single-blog.blade.php">Parents who try to be their children’s best friends</a></h3>
							<div class="post-meta">
					...
					<div class="post-item">
						...
						<div class="post-content">
							<h3><a href="single-blog.blade.php">Graduations could be delayed as external examiners</a></h3>
							<div class="post-meta">
								<span><i class="fa fa-calendar-o"></i> 23 Mar 2018</span>
								<span><i class="fa fa-user"></i> Cathrine Zeta</span>
							</div>
					...
					<div class="post-item">
						...
						<div class="post-content">
							<h3><a href="single-blog.blade.php">Private schools adopt a Ucas-style application system</a></h3>
							<div class="post-meta">
								<span><i class="fa fa-calendar-o"></i> 23 Mar 2018</span>
								<span><i class="fa fa-user"></i> Cathrine Zeta</span>
							</div>
					...
					<div class="post-item">
						...
						<div class="post-content">
							<h3><a href="single-blog.blade.php">Cambridge digs in at the top of university league table</a></h3>
							<div class="post-meta">
								<span><i class="fa fa-calendar-o"></i> 23 Mar 2018</span>
								<span><i class="fa fa-user"></i> Cathrine Zeta</span>
							</div>
